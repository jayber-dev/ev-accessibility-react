...
var Accessibility = ({ lang = "eng", position = "br", a11yDeclaration = "" }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: `ev-a11y-widget ${widgetVerticalClass} ${widgetHorizontalClass}`, children: /* @__PURE__ */ jsxs(
      "button",
      {
        ref: buttonRef,
        type: "button",
        ...
        title: t.openMenu,
        children: [
          /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: /* @__PURE__ */ jsx(BiAccessibility, { size: 25 }) }),
          /* @__PURE__ */ jsx("span", { className: "ev-a11y-trigger-shortcut", children: "Alt+A" })
        ]
      }
    ) }),
    open && /* @__PURE__ */ jsx("div", { className: "ev-a11y-overlay", "aria-hidden": "true" }),
    open && /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "ev-a11y-body", children: [
            /* @__PURE__ */ jsxs("section", { className: "ev-a11y-section", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "ev-a11y-section-title", children: t.textSize }),
                /* @__PURE__ */ jsxs("p", { className: "ev-a11y-section-text", children: [
                  t.currentSize,
                  ": ",
                  textSizeLabel
                ] })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "ev-a11y-size-grid", children: ["normal", "medium", "large", "xlarge"].map((size) => {
...
var ToggleRow = ({ title, description, checked, onChange, isHebrew }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "ev-a11y-toggle-row", children: /* @__PURE__ */ jsxs("div", { className: "ev-a11y-toggle-top", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h3", { id: titleId, className: "ev-a11y-toggle-title", children: title }),
      /* @__PURE__ */ jsx("p", { id: descriptionId, className: "ev-a11y-toggle-description", children: description })
    ] }),
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx("span", { className: "ev-a11y-toggle-knob", "aria-hidden": "true" })
      }
    )
  ] }) });
};
